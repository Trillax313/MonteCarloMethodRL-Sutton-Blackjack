...
The Blackjack_e-soft code introduces an e-soft policy where we have policy improvement and using policy improvement and policy evaluation you get your MCM method. This algorithm is in the Sutton book and introduces the reader to their first applicable RL algorithm
